          ...
          <TabsContent value="virtual" className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {drills.map((drill) => {
                ...
                return (
                  <Card key={drill.id} className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
                    <div className={`h-2 ${drill.bgColor}`}></div>
                    
                    <CardHeader className="pb-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div className={`p-3 rounded-xl bg-gray-100 text-gray-600 group-hover:${drill.bgColor.replace('bg-', 'bg-')} group-hover:text-white transition-all duration-300`}>
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">{drill.difficulty} Difficulty</p>
                          </div>
                        </div>
                        <Badge className={
                          drill.status === 'Active' ? 'bg-green-100 text-green-800' :
                          drill.status === 'Completed' ? 'bg-blue-100 text-blue-800' :
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex gap-2 pt-2">
                        <Button 
                          className={`flex-1 ${drill.status === 'Active' ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'}`}
                        >
